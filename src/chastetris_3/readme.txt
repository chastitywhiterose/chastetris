...
To support my programming work, please download the original version on either Steam or itch.io
...
The game also has the ability to save and load at any point in time. This is a neat feature that I have shown in some of my videos.

The i key saves the game
The p key loads the game

This information is in memory only for rewinding the current play session. When the game ends it is all lost.
